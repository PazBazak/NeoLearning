...
class TestWrappedGas(BaseTest):
    ...
    def test_wrapped_neo_deploy(self):
        ...
        result = self.run_smart_contract(engine, self.contract_path, method='deploy',
    ...
    def test_wrapped_neo_symbol(self):
        engine = TestEngine()
        result = self.run_smart_contract(engine, self.contract_path, 'symbol')
        self.assertEqual('zNEO', result)

    def test_wrapped_neo_decimals(self):
        self.contract_path = self.get_contract_path('wrapped_neo.py')
        engine = TestEngine()
        result = self.run_smart_contract(engine, self.contract_path, 'decimals')
    ...
    def test_wrapped_neo_total_supply(self):
        ...
        engine = TestEngine()
        result = self.run_smart_contract(engine, self.contract_path, 'totalSupply')
    ...
    def test_wrapped_neo_total_balance_of(self):
        ...
        engine = TestEngine()
        result = self.run_smart_contract(engine, self.contract_path, 'balanceOf', self.OWNER_SCRIPT_HASH)
        self.assertEqual(0, result)
        ...
        with self.assertRaises(TestExecutionException, msg=self.ASSERT_RESULTED_FALSE_MSG):
            self.run_smart_contract(engine, self.contract_path, 'balanceOf', bytes(10))
        with self.assertRaises(TestExecutionException, msg=self.ASSERT_RESULTED_FALSE_MSG):
            self.run_smart_contract(engine, self.contract_path, 'balanceOf', bytes(30))
    ...
    def test_wrapped_neo_total_transfer(self):
        ...
        with self.assertRaises(TestExecutionException, msg=self.ASSERT_RESULTED_FALSE_MSG):
            self.run_smart_contract(engine, self.contract_path, 'transfer',
        ...
        balance_before = self.run_smart_contract(engine, self.contract_path, 'balanceOf', self.OWNER_SCRIPT_HASH)
        result = self.run_smart_contract(engine, self.contract_path, 'transfer',
        ...
        balance_after = self.run_smart_contract(engine, self.contract_path, 'balanceOf', self.OWNER_SCRIPT_HASH)
        self.assertEqual(balance_before, balance_after)

        # does fire the transfer event when transferring to someone other than yourself
        balance_sender_before = self.run_smart_contract(engine, self.contract_path, 'balanceOf', self.OWNER_SCRIPT_HASH)
        balance_receiver_before = self.run_smart_contract(engine, self.contract_path, 'balanceOf', self.OTHER_ACCOUNT_1)
        result = self.run_smart_contract(engine, self.contract_path, 'transfer',
                                         self.OWNER_SCRIPT_HASH, self.OTHER_ACCOUNT_1, transferred_amount, "",
                                         signer_accounts=[self.OWNER_SCRIPT_HASH],
                                         expected_result_type=bool)
        ...
        balance_sender_after = self.run_smart_contract(engine, self.contract_path, 'balanceOf', self.OWNER_SCRIPT_HASH)
        balance_receiver_after = self.run_smart_contract(engine, self.contract_path, 'balanceOf', self.OTHER_ACCOUNT_1)
    ...
    def test_wrapped_neo_verify(self):
        ...
        result = self.run_smart_contract(engine, self.contract_path, 'verify',
                                         expected_result_type=bool)
        self.assertEqual(False, result)
    ...
    def test_wrapped_neo_burn(self):
        ...
        zneo_owner_before = self.run_smart_contract(engine, self.contract_path, 'balanceOf', self.OWNER_SCRIPT_HASH)
        # in this case, NEO will be given to the OWNER_SCRIPT_HASH
        result = self.run_smart_contract(engine, self.contract_path, 'burn', self.OWNER_SCRIPT_HASH, burned_amount,
                                         signer_accounts=[self.OWNER_SCRIPT_HASH],
                                         expected_result_type=bool)
        ...
        zneo_owner_after = self.run_smart_contract(engine, self.contract_path, 'balanceOf', self.OWNER_SCRIPT_HASH)
        ...
        with self.assertRaises(TestExecutionException, msg=self.ABORTED_CONTRACT_MSG):
            self.run_smart_contract(engine, self.contract_path, 'burn', bytes(15), burned_amount,
                                    signer_accounts=[self.OWNER_SCRIPT_HASH])
        # or amount is less than 0
        with self.assertRaises(TestExecutionException, msg=self.ABORTED_CONTRACT_MSG):
            self.run_smart_contract(engine, self.contract_path, 'burn', self.OWNER_SCRIPT_HASH, -1,
                                    signer_accounts=[self.OWNER_SCRIPT_HASH])
    ...
    def test_wrapped_neo_allowance(self):
        ...
        result = self.run_smart_contract(engine, self.contract_path, 'allowance', aux_contract_address, self.OTHER_ACCOUNT_1,
    ...
    def test_wrapped_neo_transfer_from(self):
        ...
        result = self.run_smart_contract(engine, self.contract_path, 'transfer_from', self.OTHER_ACCOUNT_1, aux_contract_address,
        ...
        balance_spender_before = self.run_smart_contract(engine, self.contract_path, 'balanceOf', self.OTHER_ACCOUNT_1)
        balance_sender_before = self.run_smart_contract(engine, self.contract_path, 'balanceOf', aux_contract_address)
        balance_receiver_before = self.run_smart_contract(engine, self.contract_path, 'balanceOf', self.OTHER_ACCOUNT_2)
        result = self.run_smart_contract(engine, self.contract_path, 'transfer_from', self.OTHER_ACCOUNT_1, aux_contract_address,
        ...
        balance_spender_after = self.run_smart_contract(engine, self.contract_path, 'balanceOf', self.OTHER_ACCOUNT_1)
        balance_sender_after = self.run_smart_contract(engine, self.contract_path, 'balanceOf', aux_contract_address)
        balance_receiver_after = self.run_smart_contract(engine, self.contract_path, 'balanceOf', self.OTHER_ACCOUNT_2)
        ...
        # should fail when any of the scripts' length is not 20
        with self.assertRaises(TestExecutionException, msg=self.ASSERT_RESULTED_FALSE_MSG):
            self.run_smart_contract(engine, self.contract_path, 'transfer_from',
    ...
    def test_wrapped_neo_onNEP17Payment(self):
        ...
        with self.assertRaises(TestExecutionException, msg=self.ABORTED_CONTRACT_MSG):
            self.run_smart_contract(engine, self.contract_path, 'onNEP17Payment', aux_address, minted_amount, None,
                                    signer_accounts=[aux_address])

        neo_wrapped_before = self.run_smart_contract(engine, constants.NEO_SCRIPT, 'balanceOf', wrapped_neo_address)
        neo_aux_before = self.run_smart_contract(engine, constants.NEO_SCRIPT, 'balanceOf', aux_address)
        zneo_aux_before = self.run_smart_contract(engine, self.contract_path, 'balanceOf', aux_address)
        ...
        zneo_aux_after = self.run_smart_contract(engine, self.contract_path, 'balanceOf', aux_address)
